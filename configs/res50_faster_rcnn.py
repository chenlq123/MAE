...
def args_faster_rcnn():
    ...
    # parser.add_argument('-p', '--path', dest='path',
    #                     help='directory to save models', default='pre_logs/cuhk_sysu/')
...
def args_faster_rcnn_mae(meta_parser=args_faster_rcnn_oim):
    parser = argparse.ArgumentParser(
        add_help=False,
        parents=[meta_parser()],
        description='MAE model based on Faster R-CNN')
